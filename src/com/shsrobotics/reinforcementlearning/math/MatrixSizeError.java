...
public class MatrixSizeError extends Error {
	...
	/**
	 * Call this when there is at least one dimension that is incompatible during
	 * a Matrix operation.
	 * 
	 * Note that the found parameter is what was found in the second Matrix in the 
	 * parameter of the Matrix operation, NOT the <code>this</code> object.
	 * 
