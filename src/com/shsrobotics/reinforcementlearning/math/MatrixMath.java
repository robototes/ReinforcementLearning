...
public class MatrixMath {
	...
	/**
	 * Private constructor because it is a static utility class. <i>MY</i> private commodities.
	 */
	 ...
	 * @param rateOfChange The value in the position of dimension {@code position.length}. 
	 *						Use {@link getPointMatrix(double[] position)} if you don't know what you are doing.
